    ...
    <div className={"containerModal"}>
      ...
      <form className={"formContainer"}>
        <div>
          ...
          <CustomField label={"Confirmation mot de passe"} type={"password"} icon={"password"} onChange={(value) => setPassword(value)}
                       value={password} fullWidth/>
        </div>
        <Button variant={"contained"} fullWidth color={"secondary"}>Inscription</Button>
      </form>
    </div>
  )
}
